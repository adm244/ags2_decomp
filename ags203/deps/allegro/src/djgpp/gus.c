...
static int gus_detect(int input);

static int gus_digi_init(int input, int voices);
static void gus_digi_exit(int input);
...
static int gus_midi_init(int input, int voices);
static void gus_midi_exit(int input);
