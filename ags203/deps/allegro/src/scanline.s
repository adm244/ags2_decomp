...
.data
		    ...
		    .align 2
__mask_mmx_15:      .long 0x03e0001f, 0x7c00
__mask_mmx_16:      .long 0x07e0001f, 0x00f8
 ...
 */
.globl __poly_scanline_gcol8
   .align 2
__poly_scanline_gcol8:
   pushl %ebp
   movl %esp, %ebp
   pushl %ebx
   pushl %esi
 ...
 */
.globl __poly_scanline_grgb8
   .align 2
__poly_scanline_grgb8:
   pushl %ebp
   movl %esp, %ebp
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_grgb8x
   .align 2
__poly_scanline_grgb8x:
   pushl %ebp
   movl %esp, %ebp
   subl $8, %esp
...
grgb_loop_x:
   ...
   movw %ax, %fs:(%edi)          /* write two pixels */
   leal 2(%edi), %edi
   jg grgb_loop_x
...
grgb_done_x:
   ...
   .align 2
grgb_last_x:
   movb %al, %fs:(%edi)          /* write last pixel */
   jmp grgb_done_x
 ...
 */
.globl __poly_scanline_atex8
   .align 2
__poly_scanline_atex8:
   INIT_ATEX()
 ...
 */
.globl __poly_scanline_atex_mask8
   .align 2
__poly_scanline_atex_mask8:
   INIT_ATEX()
 ...
 */
.globl __poly_scanline_atex_lit8
   .align 2
__poly_scanline_atex_lit8:
   INIT_ATEX(
 ...
 */
.globl __poly_scanline_ptex8
   .align 2
__poly_scanline_ptex8:
 ...
 */
.globl __poly_scanline_ptex_mask8
   .align 2
__poly_scanline_ptex_mask8:
 ...
 */
.globl __poly_scanline_ptex_lit8
   .align 2
__poly_scanline_ptex_lit8:
...
grgb_loop_##depth:                                                  ; \
   movl %ebx, %eax              /* red */                           ; \
   movb __rgb_r_shift_##depth, %cl                                  ; \
   shrl $r_sft, %eax                                                ; \
   shll %cl, %eax                                                   ; \
   movl %edi, %esi              /* green */                         ; \
   movb __rgb_g_shift_##depth, %cl                                  ; \
   shrl $g_sft, %esi                                                ; \
   shll %cl, %esi                                                   ; \
   orl %esi, %eax                                                   ; \
   movl %edx, %esi              /* blue */                          ; \
   movb __rgb_b_shift_##depth, %cl                                  ; \
   shrl $b_sft, %esi                                                ; \
   shll %cl, %esi                                                   ; \
   orl %esi, %eax                                                   ; \
   movl ADDR, %esi
 ...
 *  Fills an RGB gouraud shaded polygon scanline.
 */
.globl __poly_scanline_grgb15
   .align 2
__poly_scanline_grgb15:
   INIT_GRGB(15, 19, 19, 19)
   movw %ax, %fs:(%esi)          /* write the pixel */
   addl $2, %esi
   END_GRGB(15)
   ret                           /* end of _poly_scanline_grgb15() */

#ifdef ALLEGRO_MMX
.globl __poly_scanline_grgb15x
   .align 2
__poly_scanline_grgb15x:
   INIT_GRGB_MMX(15, 19, 19, 19)
   subl $2, %ecx
   jl 7f                        /* from here on, flags don't change */
   packssdw %mm7, %mm7
   movd %mm7, %fs:(%edi)        /* write two pixels */
   leal 4(%edi), %edi
   END_GRGB_MMX(15)
...
7:
   movd %mm7, %eax
   movw %ax, %fs:(%edi)         /* write the pixel */
   jmp 99b
#endif /* MMX */
 ...
 *  Fills an RGB gouraud shaded polygon scanline.
 */
.globl __poly_scanline_grgb16
   .align 2
__poly_scanline_grgb16:
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_grgb16x
   .align 2
__poly_scanline_grgb16x:
   ...
   movd %mm7, %eax
   movw %dx, %ax
   movl %eax, %fs:(%edi)        /* write two pixels */
   leal 4(%edi), %edi
   END_GRGB_MMX(16)
 ...
 *  Fills an RGB gouraud shaded polygon scanline.
 */
.globl __poly_scanline_grgb32
   .align 2
__poly_scanline_grgb32:
   INIT_GRGB(32, 16, 16, 16)
   movl %eax, %fs:(%esi)         /* write the pixel */
   addl $4, %esi
   END_GRGB(32)
   ret                           /* end of _poly_scanline_grgb32() */

#ifdef ALLEGRO_MMX
.globl __poly_scanline_grgb32x
   .align 2
__poly_scanline_grgb32x:
   INIT_GRGB_MMX(32, 16, 16, 16)
   subl $2, %ecx
   jl 7f
   movq %mm7, %fs:(%edi)         /* write two pixels */
   leal 8(%edi), %edi
   END_GRGB_MMX(32)
   ret                           /* end of _poly_scanline_grgb32x() */
   .align 2
7:
   movd %mm7, %fs:(%edi)         /* write the pixel */
   jmp 99b
#endif /* MMX */
#endif /* COLOR32 */
 ...
 *  Fills an RGB gouraud shaded polygon scanline.
 */
.globl __poly_scanline_grgb24
   .align 2
__poly_scanline_grgb24:
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_grgb24x
   .align 2
__poly_scanline_grgb24x:
   ...
   psrlq $32, %mm7
   movd %mm7, %eax
   movw %ax, %fs:3(%edi)         /* write second pixel */
   shrl $16, %eax
   movb %al, %fs:5(%edi)
   leal 6(%edi), %edi
   cmpl $0, %ecx
 ...
 *  Fills an affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex16
   .align 2
__poly_scanline_atex16:
   INIT_ATEX()
 ...
 *  Fills a masked affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask15
   .align 2
__poly_scanline_atex_mask15:
   INIT_ATEX()
   movw (%esi, %eax, 2), %ax     /* read texel */
   cmpw $MASK_COLOR_15, %ax
   jz 7f
   movw %ax, %fs:(%edi)          /* write solid pixels */
7: addl $2, %edi
   END_ATEX()
 ...
 *  Fills a masked affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask16
   .align 2
__poly_scanline_atex_mask16:
   INIT_ATEX()
   movw (%esi, %eax, 2), %ax     /* read texel */
 ...
 *  Fills an affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex32
   .align 2
__poly_scanline_atex32:
   INIT_ATEX()
   movl (%esi, %eax, 4), %eax    /* read texel */
   movl %eax, %fs:(%edi)         /* write the pixel */
   addl $4, %edi
   END_ATEX()
 ...
 *  Fills a masked affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask32
   .align 2
__poly_scanline_atex_mask32:
   INIT_ATEX()
   movl (%esi, %eax, 4), %eax    /* read texel */
   cmpl $MASK_COLOR_32, %eax
   jz 7f
   movl %eax, %fs:(%edi)         /* write solid pixels */
7: addl $4, %edi
   END_ATEX()
 ...
 *  Fills an affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex24
   .align 2
__poly_scanline_atex24:
   INIT_ATEX()
   leal (%eax, %eax, 2), %ecx
   movw (%esi, %ecx), %ax        /* read texel */
   movw %ax, %fs:(%edi)          /* write the pixel */
   movb 2(%esi, %ecx), %al       /* read texel */
   movb %al, %fs:2(%edi)         /* write the pixel */
   addl $3, %edi
   END_ATEX()
 ...
 *  Fills a masked affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask24
   .align 2
__poly_scanline_atex_mask24:
   INIT_ATEX()
   leal (%eax, %eax, 2), %ecx
...
#define INIT_MMX_ALPHA()                                              \
   movw 1+POLYSEG_C(%esi), %ax                                      ; \
   shrw $1, %ax                 /* alpha precision is 15 bits */    ; \
   movl $0x7fff, %edx                                               ; \
   subw %ax, %dx                /* %dx = 1-alpha */                 ; \
   shll $16, %edx                                                   ; \
   movw %ax, %dx                /* %edx = 1-alpha | alpha */        ; \
   movl %edx, ALPHA                                                 ; \
   movl %edx, ALPHA4                                                ; \
								    ; \
   movw 1+POLYSEG_DC(%esi), %ax                                     ; \
   sarw $1, %ax                 /* dalpha precision is 15 bits */   ; \
   movl %eax, %edx                                                  ; \
   negw %dx                     /* %dx = -dalpha */                 ; \
   shll $16, %edx                                                   ; \
   movw %ax, %dx                /* %edx = -dalpha | dalpha */       ; \
   movl %edx, DALPHA                                                ; \
   movl %edx, DALPHA4
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask_lit8
   .align 2
__poly_scanline_atex_mask_lit8:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_lit15
   .align 2
__poly_scanline_atex_lit15:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
   ...
   movl __blender_map15, %ecx
   movzbl 2+ALPHA, %eax
   movl (%ecx, %eax, 4), %eax   /* index in table */
   call *%eax
   addl $8, %esp
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask_lit15
   .align 2
__poly_scanline_atex_mask_lit15:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_atex_lit15x
   .align 2
__poly_scanline_atex_lit15x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
     movq __mask_mmx_15, %mm7;

     movd __blender_col_15, %mm6;    /* %mm6 = | 0 | 0 | 0 | RGB | */
     punpcklwd %mm6, %mm6;           /* %mm6 = | 0 | 0 | RGB | RGB | */
     punpckldq %mm6, %mm6;           /* %mm6 = | RGB | RGB | RGB | RGB | */
     PAND_R(7, 6)               /* pand %mm7, %mm6 */
   )
   movw (%esi, %eax, 2), %ax
   movd %eax, %mm2
   punpcklwd %mm2, %mm2
   ...
   movq %mm2, %mm3
   punpcklwd %mm6, %mm2         /* %mm2 = | G2 | G1 | B2 | B1 | */
   punpckhwd %mm6, %mm3         /* %mm3 = |  0 |  0 | R2 | R1 | */

   pmaddwd %mm0, %mm2           /* G = G1*A + G2*(1-A), B = B1*A + B2*(1-A) */
   pmaddwd %mm0, %mm3           /* R = R1*A + R2*(1-A) */
   psrld $15, %mm2              /* range = 0-255 */
   psrld $15, %mm3

   packssdw %mm3, %mm2          /* %mm2 = | 0 | R | G | B | */
   PAND_R(7, 2)                 /* pand %mm7, %mm2 */

   movq %mm2, ALPHA
   movd %mm2, %eax
   orw ALPHA2, %ax
   orw ALPHA4, %ax              /* %ax = RGB */
...
.globl __poly_scanline_atex_mask_lit15x
   .align 2
__poly_scanline_atex_mask_lit15x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
   ...
   movq %mm2, %mm3
   punpcklwd %mm6, %mm2         /* %mm2 = | G1 | G2 | B1 | B2 | */
   punpckhwd %mm6, %mm3         /* %mm3 = |  0 |  0 | R1 | R2 | */
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_lit16
   .align 2
__poly_scanline_atex_lit16:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask_lit16
   .align 2
__poly_scanline_atex_mask_lit16:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_atex_lit16x
   .align 2
__poly_scanline_atex_lit16x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
     movq __mask_mmx_16, %mm7;

     movl __blender_col_16, %eax;
     movw %ax, ALPHA;
     movw %ax, ALPHA2;
     movb %ah, ALPHA4;           /* R is shifted right, to be unsigned */
     movq ALPHA, %mm6;
     PAND_R(7, 6)               /* pand %mm7, %mm6 */
   )
   movw (%esi, %eax, 2), %ax
   ...
   movd %mm2, %eax
   orw ALPHA2, %ax
   orb ALPHA4, %ah              /* R is or'ed back to its place */
...
.globl __poly_scanline_atex_mask_lit16x
   .align 2
__poly_scanline_atex_mask_lit16x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_lit32
   .align 2
__poly_scanline_atex_lit32:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask_lit32
   .align 2
__poly_scanline_atex_mask_lit32:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_atex_lit32x
   .align 2
__poly_scanline_atex_lit32x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
     pxor %mm7, %mm7;
     movd __blender_col_32, %mm5;
     punpcklbw %mm7, %mm5;           /* extend RGB to words */
   )
   movd (%esi, %eax, 4), %mm2
   punpcklbw %mm7, %mm2             /* extend RGB to words */
   movq %mm2, %mm3
   punpcklwd %mm5, %mm2             /* G1 G2 B1 B2 */
   punpckhwd %mm5, %mm3             /*  0  0 R1 R2 */
   ...
   packssdw %mm3, %mm2              /*  0  R  G  B */
   packuswb %mm2, %mm2              /* 0R GB 0R GB */
...
.globl __poly_scanline_atex_mask_lit32x
   .align 2
__poly_scanline_atex_mask_lit32x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_lit24
   .align 2
__poly_scanline_atex_lit24:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit affine texture mapped polygon scanline.
 */
.globl __poly_scanline_atex_mask_lit24
   .align 2
__poly_scanline_atex_mask_lit24:
   INIT_ATEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_atex_lit24x
   .align 2
__poly_scanline_atex_lit24x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
     pxor %mm7, %mm7;
     movd __blender_col_24, %mm5;
     punpcklbw %mm7, %mm5;
   )
   leal (%eax, %eax, 2), %ecx
   movb 2(%esi, %ecx), %al
...
.globl __poly_scanline_atex_mask_lit24x
   .align 2
__poly_scanline_atex_mask_lit24x:
   INIT_ATEX(
     INIT_MMX_ALPHA()
     movq ALPHA, %mm0;
     movq DALPHA, %mm1;
 ...
 *  Fills a perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex16
   .align 2
__poly_scanline_ptex16:
   INIT_PTEX()
   movw (%esi, %eax, 2), %ax     /* read texel */
   movw %ax, %fs:(%edi)          /* write the pixel */
   addl $2, %edi
 ...
 *  Fills a masked perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask15
   .align 2
__poly_scanline_ptex_mask15:
   INIT_PTEX()
   movw (%esi, %eax, 2), %ax     /* read texel */
   cmpw $MASK_COLOR_15, %ax
   jz 7f
 ...
 *  Fills a masked perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask16
   .align 2
__poly_scanline_ptex_mask16:
   INIT_PTEX()
   movw (%esi, %eax, 2), %ax     /* read texel */
   cmpw $MASK_COLOR_16, %ax
   jz 7f
 ...
 *  Fills a perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex32
   .align 2
__poly_scanline_ptex32:
   INIT_PTEX()
   movl (%esi, %eax, 4), %eax    /* read texel */
   movl %eax, %fs:(%edi)         /* write the pixel */
   addl $4, %edi
 ...
 *  Fills a masked perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask32
   .align 2
__poly_scanline_ptex_mask32:
   INIT_PTEX()
   movl (%esi, %eax, 4), %eax    /* read texel */
   cmpl $MASK_COLOR_32, %eax
   jz 7f
 ...
 *  Fills a perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex24
   .align 2
__poly_scanline_ptex24:
   INIT_PTEX()
   leal (%eax, %eax, 2), %ecx
   movw (%esi, %ecx), %ax        /* read texel */
   movw %ax, %fs:(%edi)          /* write the pixel */
 ...
 *  Fills a masked perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask24
   .align 2
__poly_scanline_ptex_mask24:
   INIT_PTEX()
   leal (%eax, %eax, 2), %ecx
   xorl %eax, %eax
   movb 2(%esi, %ecx), %al       /* read texel */
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask_lit8
   .align 2
__poly_scanline_ptex_mask_lit8:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_lit15
   .align 2
__poly_scanline_ptex_lit15:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask_lit15
   .align 2
__poly_scanline_ptex_mask_lit15:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_ptex_lit15x
   .align 2
__poly_scanline_ptex_lit15x:

#define INIT()                                                          \
   INIT_MMX_ALPHA()                                                   ; \
   movl __blender_col_15, %eax                                        ; \
   movl %eax, %ecx                                                    ; \
   movl %eax, %edx                                                    ; \
   andl $0x001f, %eax                                                 ; \
   andl $0x03e0, %ecx                                                 ; \
...
.globl __poly_scanline_ptex_mask_lit15x
   .align 2
__poly_scanline_ptex_mask_lit15x:
...
.globl __poly_scanline_ptex_lit15d
   .align 2
__poly_scanline_ptex_lit15d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movl __blender_col_15, %eax
      movl %eax, %ecx
      ...
      movq ALPHA, %mm7
      movq BLEND, %mm6
      PAND_M(__mask_mmx_15, 6)                 /* pand mem, %mm6 */
   )
   movw (%esi, %eax, 2), %ax
   movd %eax, %mm4
   punpcklwd %mm4, %mm4
   punpckldq %mm4, %mm4
   PAND_M(__mask_mmx_15, 4)                 /* pand mem, %mm4 */
...
.globl __poly_scanline_ptex_mask_lit15d
   .align 2
__poly_scanline_ptex_mask_lit15d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movl __blender_col_15, %eax
      movl %eax, %ecx
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_lit16
   .align 2
__poly_scanline_ptex_lit16:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask_lit16
   .align 2
__poly_scanline_ptex_mask_lit16:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_ptex_lit16x
   .align 2
__poly_scanline_ptex_lit16x:
...
.globl __poly_scanline_ptex_mask_lit16x
   .align 2
__poly_scanline_ptex_mask_lit16x:
...
.globl __poly_scanline_ptex_lit16d
   .align 2
__poly_scanline_ptex_lit16d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movl __blender_col_16, %eax
      movl %eax, %ecx
      ...
      movq ALPHA, %mm7
      movq BLEND, %mm6
      PAND_M(__mask_mmx_16, 6)                 /* pand mem, %mm6 */
   )
   movw (%esi, %eax, 2), %ax
   movw %ax, TMP
   movw %ax, TMP2
   ...
   punpcklwd %mm4, %mm4
   punpckldq %mm4, %mm4
   PAND_M(__mask_mmx_16, 4)                 /* pand mem, %mm4 */
...
.globl __poly_scanline_ptex_mask_lit16d
   .align 2
__poly_scanline_ptex_mask_lit16d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movl __blender_col_16, %eax
      movl %eax, %ecx
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_lit32
   .align 2
__poly_scanline_ptex_lit32:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask_lit32
   .align 2
__poly_scanline_ptex_mask_lit32:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_ptex_lit32x
   .align 2
__poly_scanline_ptex_lit32x:
...
.globl __poly_scanline_ptex_mask_lit32x
   .align 2
__poly_scanline_ptex_mask_lit32x:
...
.globl __poly_scanline_ptex_lit32d
   .align 2
__poly_scanline_ptex_lit32d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movq ALPHA, %mm7
      pxor %mm5, %mm5
      movd __blender_col_16, %mm6
      punpcklbw %mm5, %mm6
   )
   movd (%esi, %eax, 4), %mm4
   pxor %mm5, %mm5
...
.globl __poly_scanline_ptex_mask_lit32d
   .align 2
__poly_scanline_ptex_mask_lit32d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movq ALPHA, %mm7
      pxor %mm5, %mm5
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_lit24
   .align 2
__poly_scanline_ptex_lit24:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
 ...
 *  Fills a lit perspective correct texture mapped polygon scanline.
 */
.globl __poly_scanline_ptex_mask_lit24
   .align 2
__poly_scanline_ptex_mask_lit24:
   INIT_PTEX(
     movl POLYSEG_C(%esi), %eax;
     movl POLYSEG_DC(%esi), %edx;
     movl %eax, ALPHA;
...
#ifdef ALLEGRO_MMX
.globl __poly_scanline_ptex_lit24x
   .align 2
__poly_scanline_ptex_lit24x:
...
.globl __poly_scanline_ptex_mask_lit24x
   .align 2
__poly_scanline_ptex_mask_lit24x:
...
.globl __poly_scanline_ptex_lit24d
   .align 2
__poly_scanline_ptex_lit24d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movq ALPHA, %mm7;
      pxor %mm5, %mm5;
...
.globl __poly_scanline_ptex_mask_lit24d
   .align 2
__poly_scanline_ptex_mask_lit24d:
   INIT_PTEX_3D(
      INIT_MMX_ALPHA()
      movq ALPHA, %mm7;
      pxor %mm5, %mm5;
