...
#define hdrAllSize              3
#define hdrSymbolOffset         4
#define hdrCodeOffset           5
#define hdrDataOffset           6
#define hdrConstsOffset         7
#define hdrInitOffset           8
#define hdrCodeSize             9
#define hdrDataSize             10
#define hdrConstsSize           11
#define hdrStackSize            12
#define hdrImportedOffset       13
//EOH! is next                  14
#define hdrHeaderSizeOf         15*4
//**************************************************************************
